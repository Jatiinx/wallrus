...
pub fn preset_names() -> &'static [&'static str] {
    &[
        "Bars", "Circle", "Plasma", "Waves", "Terrain", "Dunes", "Spark",
    ]
}
...
pub fn fragment_source_for(name: &str) -> Option<String> {
    let src = match name {
        ...
        "Spark" => include_str!("../data/shaders/spark.glsl"),
        _ => return None,
    };
    Some(assemble(src))
}
...
pub struct PresetControls {
    ...
    /// Range for the variation slider: (min, max, step, default)
    pub variation_range: (f64, f64, f64, f64),
}
...
pub fn controls_for(name: &str) -> PresetControls {
    match name {
        "Bars" => PresetControls {
            ...
            variation_range: (0.0, 1.0, 0.01, 0.0),
        },
        ...
        "Dunes" => PresetControls {
            ...
            variation_range: (0.0, 20.0, 0.1, 0.0),
        },
        "Spark" => PresetControls {
            has_angle: false,
            has_scale: true,
            has_speed: false,
            has_center: false,
